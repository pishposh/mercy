...
exports.config = {
    ...
    //
    specs: (function getSpecs (specs) {
        var spec, argv = require('optimist').argv;
        if (argv.spec) {
            specs = (typeof argv.spec === 'string') ? [argv.spec] : argv.spec;
        }
        return specs;
    })([
    ...
    //
    capabilities: [ ], // overwritten by more specific configs
    //
    // ===================
    // Test Configurations
    // ===================
    ...
    screenshotPath: null, // afterEach(screenshotIfError) can handle this
    //
